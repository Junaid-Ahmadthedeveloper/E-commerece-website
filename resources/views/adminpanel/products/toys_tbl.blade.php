                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('deletproduct',['id' => $userdata->id]) }}" type="button" class="btn btn-danger ">Delete</a>
                                    <a href="{{ route('editproduct',['id' => $userdata->id]) }}" type="button"  class="btn btn-info">Edit</a>
                                    </td>
                            </tr>
                            @endforeach
