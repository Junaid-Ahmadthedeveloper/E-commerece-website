...
<style>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Shopkeeper Table</h5>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="{{asset('shopkeeper/images/'.$userdata->image)}}" width="100px" height="100px" alt=""></td>
                                <td>{{ $userdata->store_name}}</td>
                                <td>{{ $userdata->product_type}}</td>



                                <td>
                                    {{-- <button class="btn btn-success">Edit</button> --}}
                                    <a href="{{ route('deleteuser',['id' => $userdata->id]) }}" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                            @endforeach
